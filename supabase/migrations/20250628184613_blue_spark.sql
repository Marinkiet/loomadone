/*
  ...
  1. Changes
    ...
    - Fix column reference from "total_points" to "looma_cells" in user_stats table
    - Fix ambiguous column references in update_topic_progress_after_game function
    - Fix ambiguous column references in has_completed_required_games function
  ...
  2. Details
    ...
    - The "topic_id" column was ambiguous in some queries because it exists in multiple tables
*/
